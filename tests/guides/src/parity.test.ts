...
// checks against this repo's own `guides/README.md` manifest — one row (Terminal)
...
const SELF_SPECIFIERS = ['@orkestrel/terminal', '@src/core', '@src/server']
...
// Cross-face imports are real in this multi-face package (terminal.md fences import
// `createTerminal` from `@src/server` alongside core exports) — so the fence-import
