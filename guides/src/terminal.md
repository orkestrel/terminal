...
| `CLEAR_LINE`             | const | Erase from the cursor to the end of the current line (`ESC[K`) — clears stale glyphs when a redrawn line is shorter.       |
